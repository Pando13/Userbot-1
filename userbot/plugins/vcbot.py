...
@bot.on(dev_cmd(pattern="saavn", outgoing=True))
...
@bot.on(dev_cmd(pattern="deezer", outgoing=True))
...
@bot.on(dev_cmd(pattern="play", outgoing=True))
...
@bot.on(dev_cmd(pattern="stopvc", outgoing=True))
...
@bot.on(dev_cmd(pattern="joinvc", outgoing=True))
...
@bot.on(dev_cmd(pattern="leavevc", outgoing=True))
