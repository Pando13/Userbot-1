...
@bot.on_message(filters.command('saavn') & self_or_contact_filter)
...
@bot.on_message(filters.command("deezer") & self_or_contact_filter)
...
@bot.on_message(filters.command('play') & self_or_contact_filter)
...
@bot.on_message(filters.command('stopvc') & self_or_contact_filter)
...
@bot.on_message(filters.command('joinvc') & self_or_contact_filter)
...
@bot.on_message(filters.command('leavevc') & self_or_contact_filter)
