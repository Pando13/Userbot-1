...
async def _(event):
    ...
    vuoto = ("UserStatusEmpty()")
    recente = ("UserStatusRecently()")
    settimana = ("Ultimo accesso entro una settimana")
    mese = ("Ultimo accesso entro un mese")
    if status == vuoto:
    ...
    if not (vuoto or recente or settimana or mese):
         status = ("Online")
