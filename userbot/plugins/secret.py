...
from telethon.errors import BadRequest, MessageNotModified
from telethon.types import CallbackQuery, InlineKeyboardButton, InlineKeyboardMarkup

from userbot import Config, bot

if userge.has_bot:

    @bot.bot.on_callback_query(filters.regex(pattern=r"^(secret|troll)_(.*)"))
